...
The public repository is `https://github.com/M4G3LL4N0/grokbot-office`. The inherited parent remote is not used. External worker execution, paid usage, browser sessions, cloud supervision, and deployment are not claimed. See [PUBLICATION_AUDIT.md](PUBLICATION_AUDIT.md).
